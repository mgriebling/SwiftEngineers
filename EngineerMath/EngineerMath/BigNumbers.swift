...
//			let exp10 = Double(scale) * log(2.0) / log(10.0) + 1  // add extra digits
//			var n = mpz_t()
...
//		str += work + "."; work = ""
//		while mpz_cmp_ui(&copy, 0) > 0 { addDigit() }
//		work = work.stringByTrimmingTrailingCharactersInSet(NSCharacterSet(charactersInString: "0"))
//
//		// clean up
//		mpz_clear(&copy); mpz_clear(&rem)
//		return (str + work).stringByTrimmingTrailingCharactersInSet(NSCharacterSet(charactersInString: "."))
//	}
//	
